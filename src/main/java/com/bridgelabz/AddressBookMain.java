...
public class AddressBookMain
{
    ...
    public static void main(String[] args) {
        System.out.println("Welcome to Address Book Program Computation ::");
        ...
        while (true){
            ...
            switch (ch){
                ...
                case 2:
                    ...
                    String addressBookName1 = in.next();
                ...
                case 3:
                    ...
                    String addressBookName2 = in.next();
                ...
                case 4:
                    System.out.println("Enter the address book name to edit contacts in that address book : ");
                    String addressBookName3 = in.next();
